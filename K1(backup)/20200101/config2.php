...
$footer_common_tag .= "<small> 2019 Hiroaki Akino</small>";
...
function sql($type,$userno,$sqlno,$funcno,$val,$val2,$val_array) {
	...
	$sql_array = array(
		...
		"main5_1"		=> "select column_name from information_schema.columns where table_schema = 'web1902' and table_name = 'k1_user';",
		...
		"main6_5"		=> "update k1_question set qu_status = 2 where qu_no = '${val}' ",
		"main6_6"		=> "update k1_question set qu_status = 1 where qu_no = '${val}' ",
		"main7_1"		=> "select user_delete,user_freeze,user_id,user_registration from k1_user ",
		...
		"dojo1"			=> "select qu_no,qu_title,qu_id,an_su_c/an_su_a,an_evaluation/an_su_e from k1_question,k1_answer where qu_no = an_no and qu_status = 2 and qu_delete = 0 order by an_su_a asc ,an_no desc",
