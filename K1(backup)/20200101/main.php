...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	switch($_POST["btn"]){
		...
		case "確認":
			...
			break;
		case "承認":
			sql("select",$_SESSION["user"]["type"],"main6_5","main6_5",$_POST["qu_no"],"","");
			break;
		case "却下":
			...
			<?php
				switch($_SESSION["user"]["name"]){
					case "guest":
						for($i=0;$i<2;$i++){
							if($i == 0){
								echo create_input("radio","tab_radio${i}","tab","","","checked","checked","");
							}else{
								echo create_input("radio","tab_radio${i}","tab","","","","","");
							}
