		...
		<form id="form_user" action="confilm.php" method="GET">
			<table class="t1" border="1">
				...
				<tr>
					<td>生年月日</td>
					<td>
						<?= create_input("date","user_birth_date","user_birth_date","30",$birth_date,"maxlength","8","例）19890804") ?><br>
			...
			<table class="t3" >
				...
				<tr><td><object data="./text/terms.txt" type="text/plain" width="100%" height="100%" scrolling="no"></object></td></tr>
				<tr><td><a href="personal.html" target="_blank"><i class="fas fa-caret-right"></i> プライバシーポリシー</a>について</td></tr>
